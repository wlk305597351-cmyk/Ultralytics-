...
def select_active_images(
    ...
    *,
    ...
    selected.update(select_easy_forced_review(grouped["easy"], current_epoch=current_epoch, forced_gap=easy_forced_gap))
    selected.update(
...
def _forced_selection(
    ...
    *,
    ...
    due_states = [state for state in _coerce_states(states) if current_epoch - state.last_used_epoch >= forced_gap]
