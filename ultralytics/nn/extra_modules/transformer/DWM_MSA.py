...
class DWM_MSA(nn.Module):
    ...
    def forward(self, x):
        ...
        q1, k1, v1 = map(
            lambda t: rearrange(t, "b (h b0) (w b1) c -> b (h w) (b0 b1) c", b0=w_size1[0], b1=w_size1[1]), (q1, k1, v1)
        )
        ...
        q2, k2, v2 = map(
            lambda t: rearrange(t, "b (h b0) (w b1) c -> b (h w) (b0 b1) c", b0=w_size1[0], b1=w_size1[1]), (q2, k2, v2)
        )
        ...
        q3, k3, v3 = map(
            lambda t: rearrange(t, "b (h b0) (w b1) c -> b (h w) (b0 b1) c", b0=w_size2[0], b1=w_size2[1]), (q3, k3, v3)
        )
        ...
        q4, k4, v4 = map(
            lambda t: rearrange(t, "b (h b0) (w b1) c -> b (h w) (b0 b1) c", b0=w_size2[0], b1=w_size2[1]), (q4, k4, v4)
        )
