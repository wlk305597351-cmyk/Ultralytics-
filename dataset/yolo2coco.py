...
class YOLOtoCOCO:
    def __init__(self, yolo_dir, image_dir, class_names, output_json="coco_annotations.json"):
        ...
        # COCO格式的基本结构
        self.coco_format = {"images": [], "annotations": [], "categories": []}
    ...
    def create_categories(self):
        ...
        for i, class_name in enumerate(self.class_names):
            category = {"id": i, "name": class_name, "supercategory": "object"}
    ...
    def bbox_to_segmentation(self, bbox):
        """将bbox转换为segmentation格式 矩形四个顶点，从左上角开始顺时针.
    ...
    def process_image(self, image_path, label_path):
        ...
        # 添加图片信息
        image_info = {"id": image_id, "file_name": image_path.name, "width": img_width, "height": img_height}
...
if __name__ == "__main__":
    ...
    converter = YOLOtoCOCO(
        yolo_dir=yolo_label_dir, image_dir=image_dir, class_names=class_names, output_json=output_json
    )
