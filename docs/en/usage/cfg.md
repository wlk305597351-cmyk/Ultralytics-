...
## Detection Loss Presets

For detection tasks, you can now switch classification loss and IoU loss from config/CLI without editing code.
...
By default, behavior is unchanged (`cls_loss=bce`, `iou_loss=ciou`, `iou_aux=none`).
