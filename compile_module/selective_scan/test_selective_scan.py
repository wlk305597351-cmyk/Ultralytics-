        ...
        def forward(
            ...
            if MODE in ["mamba_ssm"]:
                ...
                out, x, *rest = selective_scan_cuda.fwd(
                    u, delta, A, B, C, D, delta_bias, delta_softplus, nrows, SSOFLEX_FLOAT
                )
            elif MODE in ["sscore"]:
...
def selective_scan_fn(
    u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False, return_last_state=False, *args, **kwargs
):
